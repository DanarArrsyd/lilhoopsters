            ...
            <ul :id="$id('hoop-select') + '-list'" role="listbox" class="py-1">
                <template x-for="(option, i) in visibleOptions" :key="option.value + '-' + option.index">
                    <li :id="optionId(option)"
                        ...
                        class="mx-1 flex cursor-pointer items-center gap-2 rounded-lg px-2.5 py-2 text-sm transition-colors duration-100 {{ $centreOptions ? 'justify-center tabular-nums' : '' }}"
                        :class="{
