...
<x-sidebar-section :label="__('messages.admin.section.people')">
...
<x-sidebar-section :label="__('messages.admin.section.operations')">
...
<x-sidebar-section :label="__('messages.admin.section.finance')">
...
<x-sidebar-section :label="__('messages.admin.section.reports')">
