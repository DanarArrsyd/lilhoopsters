...
<x-sidebar-link href="{{ route('coach.news') }}" :active="request()->routeIs('coach.news')">
    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<x-sidebar-section :label="__('messages.nav.attendance')">
    <x-sidebar-link href="{{ route('coach.qr-scanner') }}" :active="request()->routeIs('coach.qr-scanner')">
        ...
        {{ __('messages.coach.nav.qr_scanner') }}
    </x-sidebar-link>
    <x-sidebar-link href="{{ route('coach.checkin') }}" :active="request()->routeIs('coach.checkin')">
        ...
        {{ __('messages.coach.nav.checkin') }}
    </x-sidebar-link>
    <x-sidebar-link href="{{ route('coach.roster') }}" :active="request()->routeIs('coach.roster')">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
        </svg>
        {{ __('messages.coach.nav.roster') }}
    </x-sidebar-link>
</x-sidebar-section>

<x-sidebar-section :label="__('messages.coach.nav.sessions_section')">
...
<x-sidebar-section :label="__('messages.section.account')">
    <x-sidebar-link href="{{ route('coach.profile') }}" :active="request()->routeIs('coach.profile')">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
        </svg>
        {{ __('messages.coach.nav.profile') }}
    </x-sidebar-link>
</x-sidebar-section>
