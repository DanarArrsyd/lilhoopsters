        ...
        <aside id="sidebar"
            ...
            <div class="h-16 flex items-center gap-3 px-4 border-b border-line">
                ...
                <div>
                    ...
                    <p class="text-faint text-[10px] uppercase tracking-wide">{{ __('messages.coach.panel') }}</p>
                </div>
            </div>
            ...
            <div class="border-t border-line p-4">
                <div class="flex items-center gap-3">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="text-muted hover:text-[#B91C1C] transition-colors p-1" :title="__('messages.coach.sign_out')">
