                ...
                <div class="px-6 py-6">
                    ...
                    @if ($step === 1)
                        <div class="space-y-5" wire:key="location-step-1">
                            ...
                            <x-input wire:model="city" name="fld_{{ uniqid() }}" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly')"
                    ...
                    @elseif ($step === 2)
                        <div class="space-y-5" wire:key="location-step-2">
                            ...
                            <x-input wire:model="maps_url" name="fld_{{ uniqid() }}" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly')"
