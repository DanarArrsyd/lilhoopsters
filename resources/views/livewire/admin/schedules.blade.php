<div>
    ...
    @else
        ...
        {{-- ═══ LIST VIEW ═══ --}}
        <div class="mb-6">
            <h2 class="text-2xl font-extrabold uppercase tracking-tight text-navy">{{ __('messages.admin.schedules.title') }}</h2>
            <p class="text-sm text-muted">{{ __('messages.admin.schedules.subtitle') }}</p>
        </div>
