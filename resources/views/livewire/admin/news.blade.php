<div>
    <div class="mb-6">
        <h2 class="text-2xl font-extrabold uppercase tracking-tight text-navy">{{ __('messages.admin.news.title') }}</h2>
        <p class="text-sm text-muted">{{ __('messages.admin.news.subtitle') }}</p>
    </div>
