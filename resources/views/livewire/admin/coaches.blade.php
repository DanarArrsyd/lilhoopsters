<div>
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-surface border border-line rounded-2xl overflow-hidden">
                ...
                <div class="px-6 py-6">
                    ...
                    {{-- ── Step 1: Account ── --}}
                    @if ($step === 1)
                        <div class="space-y-5" wire:key="coach-step-1">
                    ...
                    {{-- ── Step 2: Profile ── --}}
                    @if ($step === 2)
                        <div class="space-y-5" wire:key="coach-step-2">
                ...
                <div class="px-6 py-4 border-t border-line flex gap-3">
                    @if ($step === 1)
                        <button wire:key="coach-footer-cancel" wire:click="$set('showModal', false)"
                        ...
                        <button wire:key="coach-footer-next" wire:click="nextStep"
                    ...
                    @else
                        <button wire:key="coach-footer-prev" wire:click="prevStep"
                        ...
                        <button wire:key="coach-footer-save" wire:click="save" wire:loading.attr="disabled"
    ...
    @else
        ...
        <x-admin.page-header :title="__('messages.admin.coaches.title')" :subtitle="__('messages.admin.coaches.subtitle')">
            <x-slot name="action">
                <x-btn-add wire:click="openCreate" :label="__('messages.admin.coaches.new')" />
            </x-slot>
        </x-admin.page-header>
