                                            ...
                                            <div class="min-w-0">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    @if ($package->is_popular)
                                                        <span class="inline-flex items-center gap-0.5 text-3xs font-bold text-[#B45309] uppercase tracking-wide shrink-0">
                                                ...
                                                @endphp
                                                @if ($bits)
                                                    <p class="text-2xs text-muted truncate">{{ implode(' · ', $bits) }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 px-4">
                                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-2xs font-semibold uppercase tracking-wide {{ $meta['class'] }}">
                                            {{ $meta['label'] }}
                                        </span>
                                    </td>
