<x-auth title="Daftar">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <span class="text-xs text-slate-400">atau daftar dengan email</span>
        <div class="flex-1 h-px bg-slate-200"></div>
    </div>
    ...
    <p class="text-center text-sm text-slate-500 mt-6">
        Sudah punya akun? <a href="{{ route('login') }}" class="text-orange-500 hover:text-orange-600 font-medium">Masuk</a>
    </p>
</x-auth>
