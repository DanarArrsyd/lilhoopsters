<x-auth title="You're Almost In!">
    <div class="text-center">
        ...
        <a href="{{ $adminWhatsappLink }}?text={{ urlencode('Hi, I have registered at Lil\' Hoopsters and would like to confirm my account. Thank you!') }}"
           target="_blank"
           class="inline-flex items-center gap-2 w-full justify-center px-4 py-2.5 rounded-xl text-sm font-semibold text-white mb-4 transition-all duration-150 active:scale-[.98]"
